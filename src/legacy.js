...
const STRUCTURAL_RE = /^(PACK \d+|END OF|FIRST|SECOND|THIRD|FOURTH|_{3,}|20\d\d-\d\d|Post-Secondary|Head|Editor|Writers)/;
...
function parseQuestions(lines, combined, richSegments, posMap, lineStartPositions) {
...
// (slot i = question number i+1). Called by startGame and by reparseCurrentPdf.
